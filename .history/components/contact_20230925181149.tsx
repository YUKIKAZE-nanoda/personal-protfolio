...
export default function Contact() {
    return <section id="contact" className='mb-20 sm:mb-28 w-[min(100%,38rem)]'>
        ...
        <form className='mt-10 flex flex-col '>
            ...
            <button type="submit" className='flex items-center justify h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full outline-none transition-all'>Submit <FaPaperPlane />{""}</button>
        </form>
    </section>
}
