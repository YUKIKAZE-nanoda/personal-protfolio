...
export default function Contact() {
    ...
    >
        ...
        <p className='text-gray-700 -mt-6'>Please contact me directly at <a
            className='underline' href='mailto:example@gmail.com' action="index.php">shigure_desu@icloud.com</a>{" "}or through this form</p>
        <form className='mt-10 flex flex-col '>
            <input type='email' className='h-14 px-4  rounded-lg  borderBlack' required maxLength={500} placeholder='Your email' />
            <textarea typeof='submit' className='h-52 my-3 rounded-lg borderBlack p-4' placeholder='Your message' />
