    ...
    return <section id="contact" className='mb-20 sm:mb-28 w-[min(100%,38rem)]'>
        ...
        <form className='mt-10 flex flex-col '>
            ...
            h-[3rem] w-[8rem] bg-gray-900 text-white rounded-full
             outline-none transition-all focus:scale-110 hover:scale-110 hover:bg-gray-950 active:scale-105'>Submit <FaPaperPlane className="text-xs opacity-70 transition-all 
