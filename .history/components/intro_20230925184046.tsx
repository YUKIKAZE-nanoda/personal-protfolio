...
export default function Intro() {
  ...
  const {setActiveSection,setTimeOfLast}useActiveSectionContext();
  ...
  return (
    <section ref={ref} id='home' className=' mb-28 max-w-[50rem] text-center sm:mb-0 '>
      ...
      >
        ...
        py-3 flex items-center gap-2 rounded-full outlin-none
         hover:scale-110 focus:scale-110 hover:bg-gray-950
          active:scale-105 transtion' onClick={()=>{
