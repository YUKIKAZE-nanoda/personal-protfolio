    ...
    <section ref={ref} id='home' className=' mb-28 max-w-[50rem] text-center sm:mb-0 '>
      <div className='flex items-center justify-center'>
        <div className='relative'>
          <motion.div initial={{ opacity: 0, scale: 0 }}
            ...
            <Image src='https://konachan.net/sample/291f8b0a247bf47bba53568f4bca5ed7/Konachan.com%20-%20362988%20sample.jpg?0.5618597212672003'
              alt='shigure'
              width="192"
              height="192"
              quality="95"
      ...
      >
        <Link
          ...
          items-center gap-2 rounded-full outlin-none hover:scale-110
           focus:scale-110 hover:bg-gray-950 active:scale-105 transtion'
          onClick={() => {
        ...
        <a className='group bg-white  px-7 py-3 flex items-center gap-2
         rounded-full outlin-none hover:scale-110 focus:scale-110  active:scale-105 
         transition cursor-pointer borderBlack dark:bg-white/10 dark:text-white/60'
          href="/CV.pdf"
          download={true}>DownLoad CV<LuHardDriveDownload className="opacity-60 group-hover:tanslate-y-1 transition" /></a>
