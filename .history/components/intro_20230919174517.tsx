  ...
  return (
    <section className=' mb-28 max-w-[50rem] text-center sm:mb-0 '>
      ...
      >
        ...
        <a className='bg-white  p-4 text-gray-700 flex items-center gap-2 rounded-full text-[1.15rem] outlin-none hover:scale-[1.15] focus:scale-[1.15] hover:text-gray active:scale-105 transition cursor-pointer border border-black/10'><FaGithub /></a>
