  ...
  return (
    <section className=' mb-28 max-w-[50rem] text-center sm:mb-0 '>
      ...
      >
        ...
        <a className='group bg-white  px-7 py-3 flex items-center gap-2 rounded-full outlin-none hover:scale-110 focus:scale-110  active:scale-105 transition cursor-pointer ' href="/CV.pdf" download={true}>DownLoad CV<LuHardDriveDownload className="opacity-60 group-hover:tanslate-y-1 transition" /></a>
